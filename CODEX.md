...
- Prefer executing through the approved Design Mode plan rather than improvising a larger refactor.
...
- For feature work, keep the Product Increment Guideline in mind: every PR should have an observable outcome and a manual test path.
