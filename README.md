...
[Установить PW collection bot](https://github.com/FairHypo/pw-collection/raw/main/collection.user.js)

Mock-скрипт для тестового стенда:

[Установить PW collection bot mock dev](https://github.com/FairHypo/pw-collection/raw/main/collection.mock.user.js)

Важно: держите production и mock как два разных userscript в Tampermonkey. Production запускается только на странице Perfect World, mock запускается только на `/mock-collection`.
