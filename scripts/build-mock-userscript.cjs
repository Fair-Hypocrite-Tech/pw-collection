...
output = replaceRegex(
    output,
    /const roulette = new CollectionRoulette\(selectedPreset\.targetCategory, debugModeOn, selectedPreset\);\s*await roulette\.process\(\);/,
